...
def main(args):
    ...
    for img_path in images:
        ...
        with torch.no_grad():
            try:
                ...
                results.append({'file_name' : name, 'bpp' : rate, 'compression_time' : compression_time, 'decompression_time' : decompression_time})
    ...
    pd.DataFrame(results).to_csv(f"{args.rec_path}/stats.csv")
